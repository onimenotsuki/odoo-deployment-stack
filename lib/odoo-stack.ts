...
class OdooStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pemKeySecret = secretsmanager.Secret.fromSecretNameV2(
      this,
      'OdooPemKeySecret',
      'odoo-develop/odoo-pem-key',
    );
    ...
    // Grant the EC2 instance read access to the PEM key secret
    pemKeySecret.grantRead(role);
    ...
    // Create Key Pair from Secrets Manager
    const keyPair = new ec2.KeyPair(this, 'OdooKeyPair', {
      keyPairName: 'odoo-develop-keypair',
      // The public key will be generated by AWS, and we'll store the private key in Secrets Manager
      publicKeyMaterial: pemKeySecret.secretValue.unsafeUnwrap(),
    });
...
`;
    ...
    // Create Elastic IP
    const eip = new ec2.CfnEIP(this, 'OdooElasticIP', {
      domain: 'vpc',
    ...
    new cdk.CfnOutput(this, 'OdooUrl', {
      value: `http://${eip.ref}:8069`,
      description: 'Odoo application URL',
    });

    new cdk.CfnOutput(this, 'SSHCommand', {
      value: `ssh -i odoo-develop-keypair.pem ec2-user@${eip.ref}`,
